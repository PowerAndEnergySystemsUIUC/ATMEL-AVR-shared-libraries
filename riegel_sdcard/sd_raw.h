...
typedef uint8_t (*sd_raw_read_interval_handler_t)(uint8_t* buffer, unsigned long offset, void* p);
typedef uint16_t (*sd_raw_write_interval_handler_t)(uint8_t* buffer, unsigned long offset, void* p);
