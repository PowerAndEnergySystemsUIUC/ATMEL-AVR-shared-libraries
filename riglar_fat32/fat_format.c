...
int fatfs_create_boot_sector(struct fatfs *fs, UINT32 boot_sector_lba, UINT32 vol_sectors, const char *name)
{
	...
	// OEM Name
	fs->currentsector.sector[3]  = 'M';
	fs->currentsector.sector[4]  = 'S';
	fs->currentsector.sector[5]  = 'D';
	fs->currentsector.sector[6]  = 'O';
	fs->currentsector.sector[7]  = 'S';
	fs->currentsector.sector[8]  = '5';
	fs->currentsector.sector[9]  = '.';
	fs->currentsector.sector[10] = '0';
	...
	// Media type 
	fs->currentsector.sector[21] = 0xF8; // Fixed disk
