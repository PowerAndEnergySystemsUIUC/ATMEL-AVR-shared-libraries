...
/*
You may use these macros for debugging
#define FAT_PRINT(a)						uart_puts(a)
#define FAT_PRINT_CHAR(a)					uart_putc(a)
#define FAT_PRINT_INT8(a)					uart_puts_int8(a)
#define FAT_PRINT_INT(a)					FAT_PRINT_INT8(a)

#define FAT_PRINT_INT16(a)					uart_puts_int16(a)
#define FAT_PRINT_LONG(a)					FAT_PRINT_INT16(a)

#define FAT_PRINT_INT32(a)					uart_puts_int32(a)
*/
